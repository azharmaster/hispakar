            ...
            <div class="dropdown-toggle" data-toggle="dropdown">
              ...
              <div class="d-flex justify-content-center align-items-center" style="margin-top: -2px">
                ...
                <div class="parent-container">
                  <div class="pic-holder" style="background-image: url({{ Auth::user()->image ? asset('storage/admin/profilePic/' . Auth::user()->image) : asset('files/assets/images/profilePic/unknown.jpg') }});">
                  </div>
                </div>
