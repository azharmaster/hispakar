        ...
        <div class="page-wrapper">
          <div class="page-body">
            ...
            <div class="row">
              ...
              <!-- Start Table -->
              <!-- <div class="col-md-6">
lass="card table-card">
 class="card-header">
To Be Approved</h5>
iv class="card-header-right">
<ul class="list-unstyled card-option">
<li class="first-opt"><i class="feather icon-chevron-left open-card-option"></i></li>
<li><i class="feather icon-maximize full-card"></i></li>
<li><i class="feather icon-minus minimize-card"></i></li>
...
->
              ...
              <div class="col-md-12 col-xl-6">
                <div class="card sale-card">
                  <div class="card-header">
                    <h5>Frequently Used</h5> <!--Graph of to most used med -->
                  </div>
                  <div class="card-block">
              ...
              <div class="col-md-12 col-xl-6">
                <div class="card sale-card">
                  <div class="card-header">
                    <h5>Total Per Month</h5> <!-- Med used per month -->
                  </div>
                  <div class="card-block">
                    <div id="deal-analytic-chart" class="chart-shadow" style="height: 300px; overflow: hidden; text-align: left;">
                      <div class="amcharts-main-div" style="position: relative; width: 100%; height: 100%;">
              ...
              <!-- Start Progress Row -->
              <!-- <div class="col-xl-12">
ss="card proj-progress-card">
ss="card-block">
ss="row">
ss="col-xl-3 col-md-6">
ished Project</h6>
s="m-b-30 f-w-700">532<span class="text-c-green m-l-10">+1.69%</span></h5>
ss="progress">
ss="progress-bar bg-c-red" style="width:25%"></div>


ss="col-xl-3 col-md-6">
leted Task</h6>
s="m-b-30 f-w-700">4,569<span class="text-c-red m-l-10">-0.5%</span></h5>
ss="progress">
ss="progress-bar bg-c-blue" style="width:65%"></div>


ss="col-xl-3 col-md-6">
essfull Task</h6>
s="m-b-30 f-w-700">89%<span class="text-c-green m-l-10">+0.99%</span></h5>
ss="progress">
ss="progress-bar bg-c-green" style="width:85%"></div>


ss="col-xl-3 col-md-6">
ing Project</h6>
s="m-b-30 f-w-700">365<span class="text-c-green m-l-10">+0.35%</span></h5>
ss="progress">
ss="progress-bar bg-c-yellow" style="width:45%"></div>
...
ss="card latest-update-card">
ss="card-header">
st Activity</h5>
ss="card-header-right">
s="list-unstyled card-option">
s="first-opt"><i class="feather icon-chevron-left open-card-option"></i></li>
lass="feather icon-maximize full-card"></i></li>
lass="feather icon-minus minimize-card"></i></li>
lass="feather icon-refresh-cw reload-card"></i></li>
lass="feather icon-trash close-card"></i></li>
lass="feather icon-chevron-left open-card-option"></i></li>



ss="card-block">
ss="scroll-widget">
ss="latest-update-box">
ss="row p-t-20 p-b-30">
ss="col-auto text-right update-meta p-r-0">
="b-primary update-icon ring"></i>

ss="col p-l-5">
"#!"><h6>Rescheduled appointment</h6></a>
="text-muted m-b-0">Lorem ipsum dolor sit amet, <a href="#!" class="text-c-blue"> More</a></p>
...
ss="col p-l-5">
"#!"><h6>Referred to specialist</h6></a>
="text-muted m-b-0">Lorem dolor sit amet, <a href="#!" class="text-c-blue"> More</a></p>


ss="row p-b-30">
ss="col-auto text-right update-meta p-r-0">
="b-success update-icon ring"></i>

ss="col p-l-5">
"#!"><h6>Urgent Care</h6></a>
="text-muted m-b-0">Lorem ipsum dolor sit ipsum amet, <a href="#!" class="text-c-green"> More</a></p>


ss="row p-b-30">
ss="col-auto text-right update-meta p-r-0">
="b-danger update-icon ring"></i>

ss="col p-l-5">
"#!"><h6>Your Manager Posted.</h6></a>
="text-muted m-b-0">Lorem ipsum dolor sit amet, <a href="#!" class="text-c-red"> More</a></p>
...
<script>
  ...
  new Chart(ctx2, {
    type: 'bar',
    data: {
      labels: ['Cardiology', 'Physiology', 'Gastrology', 'Oncology', 'Urology', 'Neurology', 'Orthopedic', 'Psychiatry'],
      datasets: [{
        label: '# of Votes',
        data: [12, 19, 3, 5, 2, 3],
        borderWidth: 1
