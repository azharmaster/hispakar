...
<script src="{{ asset('files/assets/jquery/jquery.min.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('files/bower_components/modernizr/js/modernizr-1.js') }}"></script>
<script type="text/javascript" src="{{ asset('files/bower_components/modernizr/js/css-scrollbars-1.js') }}"></script>
...
<script src="{{ asset('files/assets/pages/data-table/extensions/buttons/js/extension-btns-custom-1.js') }}"></script>
<script src="{{ asset('files/assets/pages/data-table/extensions/responsive/js/responsive-custom-1.js') }}"></script>
...
<script src="{{ asset('files/assets/js/jquery.mCustomScrollbar.concat.min-1.js') }}"></script>
