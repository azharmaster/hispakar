            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">
                            <a href="/doctor/patientList">Patients</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <button type="button" class="btn btn-mat waves-effect waves-light btn-primary d-block mx-auto float-right" data-toggle="modal" 
                                        data-target="#addModal-patient" title="Add Doctor">
                                                    ...
                                                    @foreach($patients as $patient)
                                                        <tr style="text-align: center;">
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="/doctor/patientList/{{ $patient->id }}" title="Delete Patient" data-toggle="modal" data-target="#deleteModal-patient-{{ $patient->id }}">
